...
{
    public class PracticaSupervisadaIngenieriaRepo : IPracticaSupervisadaIngenieriaRepo
        {
            ...
            public async Task<IEnumerable<PracticaSupervisadaIngenieria>> GetPracticaSupervisadaIngenieria()
             ...
             {
                 return await gIUCTDbContext.PracticaSupervisadaIngenierias.FirstOrDefaultAsync(f => f.Id == idP);
             }
        ...
        {
            var result = await gIUCTDbContext.PracticaSupervisadaIngenierias
    ...
    public async Task<IActionResult> EliminarPracticaSupervisadaIngenieria(int id)
        {
            ...
            if (result != null)
            {
                gIUCTDbContext.PracticaSupervisadaIngenierias.Remove(result);
                await gIUCTDbContext.SaveChangesAsync();
