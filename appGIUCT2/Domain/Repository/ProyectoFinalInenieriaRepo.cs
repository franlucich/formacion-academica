...
{
    public class ProyectoFinalIngenieriaRepo : IProyectoFinalIngenieriaRepo
        {
            private readonly GIUCTDbContext gIUCTDbContext;
            public readonly ILogger _logger;
            
            public ProyectoFinalIngenieriaRepo(GIUCTDbContext gIUCTDbContext, ILogger logger)
            {
            ...
            public async Task<IEnumerable<ProyectoFinalIngenieria>> GetProyectoFinalIngenieria()
             ...
             {
                 return await gIUCTDbContext.ProyectoFinalIngenierias.FirstOrDefaultAsync(f => f.Id == idP);
             }
        ...
        {
            var result = await gIUCTDbContext.ProyectoFinalIngenierias
    ...
    public async Task<IActionResult> EliminarProyectoFinalIngenieria(int id)
        {
            ...
            if (result != null)
            {
                gIUCTDbContext.ProyectoFinalIngenierias.Remove(result);
                await gIUCTDbContext.SaveChangesAsync();
